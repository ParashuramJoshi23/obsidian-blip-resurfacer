...
var BlipResurfacerPlugin = class extends import_obsidian.Plugin {
  ...
  async getBlipFiles() {
    return this.app.vault.getMarkdownFiles().filter((file) => this.isBlipFile(file)).sort((a, b) => a.stat.mtime - b.stat.mtime);
  }
